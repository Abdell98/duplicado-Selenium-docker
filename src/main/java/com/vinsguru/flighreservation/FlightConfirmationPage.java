...
public class FlightConfirmationPage extends AbstractPage {
    ...
    @FindBy (css = "#flights-confirmation-section .card-body .row:nth-child(1) .col:nth-child(2)") //#flights-confirmation-section .card-body .row:nth-child(1) .col:nth-child(2)
